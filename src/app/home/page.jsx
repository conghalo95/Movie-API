...
const Home = () => {
    return (
        <div className="justify-center text-center h-full overflow-hidden relative">
            ...
            <p className="text-6xl font-bold">Discover new music <br />every day</p>
            <p className="mt-5 mb-3">Get playlists and albums inspired by the artists and genres <br /> you are listening to. 1 month free, then <br /> 65.000 ₫/month.</p>
            <button className="bg-rose-600 mt-2 mb-5 w-32 h-8 rounded-md text-sm">Try it free</button><br />
            <button>
                <p className="text-sm flex items-center hover:underline">Learn more<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-3 ms-1">
                    <path fill-rule="evenodd" d="M16.28 11.47a.75.75 0 0 1 0 1.06l-7.5 7.5a.75.75 0 0 1-1.06-1.06L14.69 12 7.72 5.03a.75.75 0 0 1 1.06-1.06l7.5 7.5Z" clip-rule="evenodd" />
                </svg></p>
            </button>

            <img src="/macbook.webp"
                className="absolute w-full scale-90 -bottom-[550px]" alt="" />
        </div>
    );
};
