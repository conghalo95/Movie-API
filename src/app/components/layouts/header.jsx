...
const Header = () => {
    ...
    return (
        <div className="bg-neutral-800 h-full w-fit divide-y divide-neutral-900 border-r border-r-neutral-700">
            <div className="w-64 h-[93%] px-6 py-6">
                <svg className="" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="88px" height="22px" viewBox="0 0 88 22" enable-background="new 0 0 88 22" xmlSpace="preserve">
                    <g>
                ...
                <div className="relative my-5">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4 absolute top-2 start-2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                    </svg>
                    <input type="text" placeholder="Search" className="bg-neutral-900 w-full placeholder:text-neutral-600 h-8 border border-neutral-700 ps-7 block rounded text-xs" />
                </div>
                <Link href="/home">
                    <div className="flex py-1 rounded hover:bg-neutral-700 items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 mx-2 fill-rose-600">
                ...
                <Link href="/">
                    <div className="flex my-1 py-1 rounded hover:bg-neutral-700 items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 mx-2 fill-rose-600">
                            <path fill-rule="evenodd" d="M3 6a3 3 0 0 1 3-3h2.25a3 3 0 0 1 3 3v2.25a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V6Zm9.75 0a3 3 0 0 1 3-3H18a3 3 0 0 1 3 3v2.25a3 3 0 0 1-3 3h-2.25a3 3 0 0 1-3-3V6ZM3 15.75a3 3 0 0 1 3-3h2.25a3 3 0 0 1 3 3V18a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3v-2.25Zm9.75 0a3 3 0 0 1 3-3H18a3 3 0 0 1 3 3V18a3 3 0 0 1-3 3h-2.25a3 3 0 0 1-3-3v-2.25Z" clip-rule="evenodd" />
                        </svg>
                        <p className="text-[15px]">Browse</p>
                    </div>
                </Link>
                <Link href="/radio">
                    <div className="flex py-1 rounded hover:bg-neutral-700 items-center">
                        ...
                        <p className="text-[15px]">Radio</p>
                    </div>
                </Link>
            </div>
            <div className="w-64 h-[7%] px-6 py-6 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-7 px-1 py-1 rounded-full border">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m9 9 10.5-3m0 6.553v3.75a2.25 2.25 0 0 1-1.632 2.163l-1.32.377a1.803 1.803 0 1 1-.99-3.467l2.31-.66a2.25 2.25 0 0 0 1.632-2.163Zm0 0V2.25L9 5.25v10.303m0 0v3.75a2.25 2.25 0 0 1-1.632 2.163l-1.32.377a1.803 1.803 0 0 1-.99-3.467l2.31-.66A2.25 2.25 0 0 0 9 15.553Z" />
                </svg>
                <p className="ms-2 me-1 text-sm">Open in Music</p>
